    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <router-link class="nav-link" v-if="isLoggedIn" to="/upload_song">Creator Account</router-link>
          </li>
          <li class="nav-item" >
          ...
          <li class="nav-item" v-if="isLoggedIn">
            <router-link class="nav-link" to="/all_creators">Creators Dashboard</router-link>
          </li>
          <li class="nav-item" v-if="!isLoggedIn">
